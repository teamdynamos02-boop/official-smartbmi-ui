...
export default function SexPage({ sex, setSex, onBack, onNext, onCancel }) {
    ...
    <div className="sex-stage">
      ...
      <div className="panel panel-large center-page input-step-panel">
        ...
        <div className="sex-buttons">
          <button type="button" className={`btn sex-btn sex-btn-male ${sex === "Male" ? "sex-btn-active" : ""}`} onClick={() => setSex("Male")}>
            <Mars className="sex-btn-icon" />
            Male
          </button>
          <button type="button" className={`btn sex-btn sex-btn-female ${sex === "Female" ? "sex-btn-active" : ""}`} onClick={() => setSex("Female")}>
      ...
      <div className="actions sex-actions">
        ...
        <button type="button" className="btn btn-primary btn-xl sex-next-btn" disabled={!valid} onClick={onNext}>Next</button>
      </div>
    </div>
  );
}
